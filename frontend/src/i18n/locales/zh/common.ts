export default {
  ...
  auth: {
    ...
    phoneCodePlaceholder: '请输入 {length} 位验证码',
    invalidPhone: '请输入有效的中国大陆手机号',
    phoneCodeRequired: '请先输入验证码',
    phoneCodeSent: '验证码已发送，请查收短信。',
    phoneDeliverySubmitted: '短信供应商已接受请求，但尚未确认送达。',
    phoneDeliverySending: '正在提交短信请求...',
    phoneDeliveryFailed: '短信请求失败。',
    phoneDeliveryUnknown: '暂时无法获取短信提交状态。',
    phoneCodeExpired: '验证码已过期，请重新获取。',
    phoneRegistrationDisabled: '手机号新用户注册已关闭，已有账户仍可登录。',
    phoneRegistrationHint: '如果该手机号尚未注册，登录时可能创建新账户。',
    phoneExistingAccount: '已有账户？请使用邮箱或站点其他方式登录，再到个人资料中绑定手机号。',
    signingIn: '登录中...',
    ...
    desktopCaptcha: {
      ...
      start: '开始验证',
      submitting: '正在完成验证...',
      complete: '验证已完成，请返回桌面应用。',
      failed: '无法完成验证。',
      unavailable: '桌面验证不可用或配置不完整。'
    },
