export default {
    settings: {
      desktop: {
        title: 'Aino 内置模型',
        description: '选择向桌面端开放的模型。用户仍须拥有对应分组或订阅权限。',
        enabled: '启用桌面内置模型',
        pricingHint: '价格与用户倍率沿用分组、渠道及现有计费规则。请先完成真实工具调用和流式回复验证，再勾选已验证并启用。',
        defaultModel: '默认模型',
        noDefault: '不设默认，由用户选择',
        credentialTTL: '调用凭据有效期（秒，300–3600）',
        groupsFailed: '分组加载失败，已填写的模型配置仍保留。',
        empty: '尚未添加模型。添加后保存设置，才能在桌面端目录中生效。',
        newModel: '待配置模型',
        add: '添加内置模型',
        id: '目录 ID（用于会话恢复，发布后请保持稳定）',
        display_name: '显示名称',
        model: '实际模型 ID',
        provider_label: '供应商显示名称',
        group: '现有分组',
        platform: '实际模型平台',
        protocol: '调用协议',
        sortOrder: '排序（小值优先）',
        ...
        vision: '支持图片输入',
        reasoning: '支持推理',
        verified: '已验证该分组、模型和协议的 Agent 工具调用与流式回复',
        unavailableGroup: '分组不存在或已停用'
      },
      title: '系统设置',
      description: '管理注册、邮箱验证、默认值和 SMTP 设置',
      sms: {
        title: '短信验证',
        description: '配置手机号验证策略。供应商凭据仅由部署环境提供。',
        credentials: '供应商凭据',
        hmac: '证明签名密钥',
        readiness: '服务就绪状态',
        configured: '已配置',
        ...
        templateParams: '模板变量映射（JSON）',
        invalidTemplateParams: '请输入 JSON 对象，且值必须是受支持的语义字段。',
        codeLength: '验证码长度',
        ttlSeconds: '验证码有效期（秒）',
        cooldownSeconds: '重发冷却时间（秒）',
        maxAttempts: '最大验证次数',
        phoneHourLimit: '单手机号每小时上限',
        phoneDayLimit: '单手机号每日上限',
        ipHourLimit: '单 IP 每小时上限',
        globalDayLimit: '全局每日上限',
        testTitle: '发送测试短信',
        testPhone: '接收手机号',
        sendTest: '发送测试',
        testSubmitted: '测试短信已提交：{delivery}',
        testFailed: '测试短信发送失败'
      },
      tabs: {
        general: '通用设置',
