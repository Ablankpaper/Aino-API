export default {
  ...
  auth: {
    ...
    phoneCodePlaceholder: 'Enter the {length}-digit code',
    invalidPhone: 'Please enter a valid mainland China mobile number',
    phoneCodeRequired: 'Enter the verification code first',
    phoneCodeSent: 'Verification code sent. Please check your phone.',
    phoneDeliverySubmitted: 'The SMS provider accepted the request; delivery is not yet confirmed.',
    phoneDeliverySending: 'Submitting the SMS request...',
    phoneDeliveryFailed: 'The SMS request failed.',
    phoneDeliveryUnknown: 'The SMS submission status is unavailable.',
    phoneCodeExpired: 'This verification code has expired. Request a new one.',
    phoneRegistrationDisabled: 'New phone registrations are disabled. Existing accounts can still sign in.',
    phoneRegistrationHint: 'A new account may be created if this number is not registered.',
    phoneExistingAccount: 'Have an existing account? Use email or another site sign-in, then bind your phone in Profile.',
    ...
    desktopCaptcha: {
      ...
      submitting: 'Completing verification...',
      complete: 'Verification complete. You may return to the desktop app.',
      failed: 'Verification could not be completed.',
      unavailable: 'Desktop verification is unavailable or misconfigured.'
    },
