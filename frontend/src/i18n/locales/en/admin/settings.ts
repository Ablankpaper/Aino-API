export default {
    settings: {
      desktop: {
        title: 'Aino built-in models',
        description: 'Choose models offered in the desktop app. Existing group and subscription permissions still apply.',
        enabled: 'Enable desktop built-in models',
        pricingHint: 'Prices and user rates come from existing group, channel and billing rules. Verify real Agent tool calls and streaming before marking a model verified and enabling the catalog.',
        defaultModel: 'Default model',
        noDefault: 'No default; let the user choose',
        credentialTTL: 'Inference credential lifetime (seconds, 300–3600)',
        groupsFailed: 'Could not load groups. Your model configuration has been preserved.',
        empty: 'No models yet. Add a model and save settings to update the desktop catalog.',
        newModel: 'Model to configure',
        add: 'Add built-in model',
        id: 'Catalog ID (keep stable after publishing for session recovery)',
        display_name: 'Display name',
        model: 'Actual model ID',
        provider_label: 'Provider display name',
        group: 'Existing group',
        platform: 'Actual model platform',
        protocol: 'API protocol',
        sortOrder: 'Sort order (lowest first)',
        context_window: 'Context window',
        max_output_tokens: 'Maximum output tokens',
        unknown: 'Leave blank if unknown',
        tools: 'Tool calls',
        vision: 'Image input',
        reasoning: 'Reasoning',
        verified: 'Agent tool calls and streaming have been verified for this group, model and protocol',
        unavailableGroup: 'Missing or inactive group'
      },
      title: 'System Settings',
      description: 'Manage registration, email verification, default values, and SMTP settings',
      sms: {
        title: 'SMS verification',
        description: 'Configure phone verification policy. Provider credentials remain deployment-only.',
        credentials: 'Provider credentials',
        hmac: 'Proof signing secret',
        ...
        templateParams: 'Template variable mapping (JSON)',
        invalidTemplateParams: 'Enter a JSON object whose values are supported semantic fields.',
        codeLength: 'Code length',
        ttlSeconds: 'Code lifetime (seconds)',
        cooldownSeconds: 'Resend cooldown (seconds)',
        maxAttempts: 'Maximum verification attempts',
        phoneHourLimit: 'Per-phone hourly limit',
        phoneDayLimit: 'Per-phone daily limit',
        ipHourLimit: 'Per-IP hourly limit',
        globalDayLimit: 'Global daily limit',
        testTitle: 'Send a test message',
        testPhone: 'Receiver mobile number',
        sendTest: 'Send test',
        testSubmitted: 'Test message submitted: {delivery}',
