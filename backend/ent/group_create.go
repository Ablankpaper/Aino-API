...
func (_c *GroupCreate) AddDesktopModelCredentialIDs(ids ...int64) *GroupCreate {
...
func (_c *GroupCreate) AddDesktopModelCredentials(v ...*DesktopModelCredential) *GroupCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
