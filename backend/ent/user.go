...
// was not loaded in eager-loading.
func (e UserEdges) DesktopModelCredentialsOrErr() ([]*DesktopModelCredential, error) {
	if e.loadedTypes[13] {
...
// QueryDesktopModelCredentials queries the "desktop_model_credentials" edge of the User entity.
func (_m *User) QueryDesktopModelCredentials() *DesktopModelCredentialQuery {
	return NewUserClient(_m.config).QueryDesktopModelCredentials(_m)
}
