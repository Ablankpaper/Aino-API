...
func (_u *UserUpdate) AddDesktopModelCredentialIDs(ids ...int64) *UserUpdate {
...
func (_u *UserUpdate) AddDesktopModelCredentials(v ...*DesktopModelCredential) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) ClearDesktopModelCredentials() *UserUpdate {
...
func (_u *UserUpdate) RemoveDesktopModelCredentialIDs(ids ...int64) *UserUpdate {
...
func (_u *UserUpdate) RemoveDesktopModelCredentials(v ...*DesktopModelCredential) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.DesktopModelCredentialsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.DesktopModelCredentialsTable,
			Columns: []string{user.DesktopModelCredentialsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// AddDesktopModelCredentialIDs adds the "desktop_model_credentials" edge to the DesktopModelCredential entity by IDs.
func (_u *UserUpdateOne) AddDesktopModelCredentialIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddDesktopModelCredentialIDs(ids...)
	return _u
}

// AddDesktopModelCredentials adds the "desktop_model_credentials" edges to the DesktopModelCredential entity.
func (_u *UserUpdateOne) AddDesktopModelCredentials(v ...*DesktopModelCredential) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearDesktopModelCredentials clears all "desktop_model_credentials" edges to the DesktopModelCredential entity.
func (_u *UserUpdateOne) ClearDesktopModelCredentials() *UserUpdateOne {
	_u.mutation.ClearDesktopModelCredentials()
	return _u
}

// RemoveDesktopModelCredentialIDs removes the "desktop_model_credentials" edge to DesktopModelCredential entities by IDs.
func (_u *UserUpdateOne) RemoveDesktopModelCredentialIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveDesktopModelCredentialIDs(ids...)
	return _u
}

// RemoveDesktopModelCredentials removes "desktop_model_credentials" edges to DesktopModelCredential entities.
func (_u *UserUpdateOne) RemoveDesktopModelCredentials(v ...*DesktopModelCredential) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
