...
var usageLogInsertArgTypes = [...]string{
	...
	"text",        // desktop_turn_id
	"text",        // desktop_call_id
	"text",        // desktop_purpose
...
func prepareUsageLogInsert(log *service.UsageLog) usageLogInsertPrepared {
	...
	return usageLogInsertPrepared{
		...
		args: []any{
			...
			nullString(log.DesktopTurnID),
			nullString(log.DesktopCallID),
			nullString(log.DesktopPurpose),
			nullString(optionalSettlementStatus(log.SettlementStatus)),
			createdAt,
		},
	}
}
